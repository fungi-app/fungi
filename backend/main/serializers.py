...
from main.models import (Color, Image, 
...
class MushroomSerializer(serializers.ModelSerializer):
    class Meta:
        model = Mushroom 
        fields = ['id', 'name', 'latin_name', 'synonymous_names', 'slug', 'family', 'red_booked', 'description', 'eatable', 'have_foot', 'foot_size_from', 'foot_size_to', 'foot_type', 'foot_color', 'head_type', 'hymenophore', 'head_color', 'created_at', 'updated_at', 'head_color', 'mushroom_images']
